...
;
INSERT INTO treebanks SELECT id, server_id, database, name, title, homepage, handle, description, is_public, is_free, is_all_logged, is_featured, created_at, last_modified FROM treebanks_temp_alter;
