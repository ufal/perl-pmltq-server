...
;
INSERT INTO users_temp_alter( id, persistent_token, organization, provider, name, username, email, password, access_all, is_admin, is_active, created_at, last_login) SELECT id, persistent_token, organization, provider, name, username, email, password, access_all, is_admin, is_active, created_at, last_login FROM users;
...
;
INSERT INTO users SELECT id, persistent_token, organization, provider, name, username, email, password, access_all, is_admin, is_active, created_at, last_login FROM users_temp_alter;
