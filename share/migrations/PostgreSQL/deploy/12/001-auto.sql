...
CREATE TABLE "users" (
  ...
  "allow_history" boolean DEFAULT '1' NOT NULL,
  "allow_query_lists" boolean DEFAULT '1' NOT NULL,
  "allow_publish_query_lists" boolean DEFAULT '1' NOT NULL,
...
CREATE TABLE "treebanks" (
  ...
  "is_all_logged" boolean DEFAULT '1' NOT NULL,
