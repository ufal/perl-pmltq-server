...
-- Created on Wed Apr 12 11:12:43 2017
-- 
;
...
CREATE TABLE `query_records` (
  ...
  `is_public` enum('0','1') NOT NULL DEFAULT '0',
  `description` text NULL,
  `ord` integer NULL DEFAULT 0,
  `eval_num` integer NULL DEFAULT 0,
  `first_used_treebank` integer NULL,
  `created_at` datetime NOT NULL,
  `last_use` datetime NOT NULL,
  `hash` char(32) NULL,
  INDEX `query_records_idx_query_file_id` (`query_file_id`),
  INDEX `query_records_idx_first_used_treebank` (`first_used_treebank`),
  ...
  CONSTRAINT `query_records_fk_first_used_treebank` FOREIGN KEY (`first_used_treebank`) REFERENCES `treebanks` (`id`),
