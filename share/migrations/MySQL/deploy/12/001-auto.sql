...
-- Created on Tue Jan 28 10:57:14 2020
-- 
;
...
CREATE TABLE `users` (
  ...
  `allow_history` enum('0','1') NOT NULL DEFAULT '1',
  `allow_query_lists` enum('0','1') NOT NULL DEFAULT '1',
  `allow_publish_query_lists` enum('0','1') NOT NULL DEFAULT '1',
