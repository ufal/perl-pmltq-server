...
;
ALTER TABLE users ADD COLUMN allow_history enum('0','1') NOT NULL DEFAULT '1',
                  ADD COLUMN allow_query_lists enum('0','1') NOT NULL DEFAULT '1',
                  ADD COLUMN allow_publish_query_lists enum('0','1') NOT NULL DEFAULT '1';
